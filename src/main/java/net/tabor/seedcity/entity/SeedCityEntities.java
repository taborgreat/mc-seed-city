...
/** The five city mobs. Hitboxes match the models in {@code src/client}. */
public final class SeedCityEntities {
	...
	public static void init() {
		...
		SENTINEL = Registry.register(BuiltInRegistries.ENTITY_TYPE, sentinelKey,
				EntityType.Builder.of(SentinelEntity::new, MobCategory.MONSTER).sized(0.9F, 2.63F).clientTrackingRange(8).build(sentinelKey));
		...
		COURIER = Registry.register(BuiltInRegistries.ENTITY_TYPE, courierKey,
				EntityType.Builder.of(CourierEntity::new, MobCategory.MISC).sized(0.48F, 0.48F).clientTrackingRange(10).build(courierKey));
		...
		COLLECTOR = Registry.register(BuiltInRegistries.ENTITY_TYPE, collectorKey,
				EntityType.Builder.of(CollectorEntity::new, MobCategory.MISC).sized(0.9F, 1.8F).clientTrackingRange(10).build(collectorKey));
